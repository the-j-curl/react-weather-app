...
import { convertLocalTime } from 'shared/variables';
...
export const CurrentWeather: React.FC<Props> = ({ weather, error, status }) => {
  ...
  return (
    <CurrentContainer>
      ...
      <p>Temp: {weather?.current.temp && Math.floor(weather?.current.temp)}c</p>
